...
import com.keren.courrier.jaxrs.ifaces.referentiel.CiviliteRS;
    ...
    implements CiviliteRS
{
     ...
     * 
     */
    @Manager(application = "kerencourrier", name = "CiviliteManagerImpl", interf = CiviliteManagerRemote.class)
