...
import com.keren.courrier.jaxrs.ifaces.courrier.CourrierAClasserRS;
 ...
 * 
 */
@Path("/courrieraclasser")
public class CourrierAClasserRSImpl
    extends AbstractGenericService<CourrierAClasser, Long>
    implements CourrierAClasserRS
{
     ...
     * 
     */
    @Manager(application = "kerencourrier", name = "CourrierAClasserManagerImpl", interf = CourrierAClasserManagerRemote.class)
    protected CourrierAClasserManagerRemote manager;    
     ...
     */
    @Override
    public GenericManager<CourrierAClasser, Long> getManager() {
        return manager;
    }
...
//        System.out.println(AbstractGenericService.class.toString()+".count === "+" == "+number.getValue());
    ...
    @Override
    public List<CourrierAClasser> filter(HttpHeaders headers, int firstResult, int maxResult) {
        //To change body of generated methods, choose Tools | Templates.
         Gson gson = new Gson();
        Long userid = gson.fromJson(headers.getRequestHeader("userid").get(0), Long.class);
        UtilisateurCourrier user = usermanager.getUserByAcompte(userid);
