...
import com.keren.courrier.jaxrs.ifaces.referentiel.ContactRS;
    ...
    implements ContactRS
{
     ...
     * 
     */
    @Manager(application = "kerencourrier", name = "ContactManagerImpl", interf = ContactManagerRemote.class)
