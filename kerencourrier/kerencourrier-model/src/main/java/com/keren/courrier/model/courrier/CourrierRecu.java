...
public class CourrierRecu extends BaseElement implements Serializable, Comparable<CourrierRecu> {
	...
	public CourrierRecu(String categorie, String niveauDeTraitement, TypeCourrier typecourrier, Priorite priorite,
	...
	public CourrierRecu(CourrierRecu dep) {
...
//			this.origanal = new CourrierRecu(dep.origanal);
//		}
//		if (dep.bordero != null) {
...
//		}
	...
	public CourrierRecu(CourrierDepart dep) {
	...
	public CourrierRecu(Courrier dep) {
		super(dep.getId(), dep.getDesignation(), dep.getModuleName(), dep.getCompareid());
		this.categorie = dep.getCategorie();
		this.code = dep.getCode();
	...
	public CourrierRecu(CourrierInterne dep) {
		super(dep.getId(), dep.getDesignation(), dep.getModuleName(), dep.getCompareid());
		this.categorie = dep.getCategorie();
		this.code = dep.getCode();
	...
	public CourrierRecu getOriganal() {
		return origanal;
	}

	public void setOriganal(CourrierRecu origanal) {
	...
	@Override
	public int compareTo(CourrierRecu o) {
		// TODO Auto-generated method stub
		return code.compareTo(o.code);
	}

	public CourrierRecu newInstace() {
		CourrierRecu entity = new CourrierRecu();
		...
		if (this.origanal != null) {
			entity.origanal = new CourrierRecu(this.origanal);
		}
