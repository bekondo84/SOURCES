...
public class CourrierAClasser extends BaseElement implements Serializable, Comparable<CourrierAClasser> {
	...
	private CourrierAClasser origanal;
	...
	public CourrierAClasser(String categorie, String niveauDeTraitement, TypeCourrier typecourrier, Priorite priorite,
	 ...
	 * 
	 */
	public CourrierAClasser() {
		// TODO Auto-generated constructor stub
	}

	public CourrierAClasser(CourrierAClasser dep) {
...
//		}
	...
	public CourrierAClasser(CourrierDepart dep) {
	...
	public CourrierAClasser(Courrier dep) {
		super(dep.getId(), dep.getDesignation(), dep.getModuleName(), dep.getCompareid());
		this.categorie = dep.getCategorie();
		this.code = dep.getCode();
	...
	public CourrierAClasser(CourrierInterne dep) {
		super(dep.getId(), dep.getDesignation(), dep.getModuleName(), dep.getCompareid());
		this.categorie = dep.getCategorie();
		this.code = dep.getCode();
	...
	public CourrierAClasser getOriganal() {
		return origanal;
	}

	public void setOriganal(CourrierAClasser origanal) {
	...
	@Override
	public int compareTo(CourrierAClasser o) {
		// TODO Auto-generated method stub
		return code.compareTo(o.code);
	}

	public CourrierAClasser newInstace() {
		CourrierAClasser entity = new CourrierAClasser();
		...
		if (this.origanal != null) {
			entity.origanal = new CourrierAClasser(this.origanal);
		}
