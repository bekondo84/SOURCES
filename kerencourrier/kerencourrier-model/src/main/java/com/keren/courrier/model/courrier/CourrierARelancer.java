...
public class CourrierARelancer extends BaseElement implements Serializable, Comparable<CourrierARelancer> {
	...
	@Predicate(label = "Mention du courrier", target = "combobox", values = "Ordinaire;Confidentiel", editable = false)
	...
	@Temporal(javax.persistence.TemporalType.DATE)
	@Predicate(label = "Date limite", type = Date.class, target = "date", editable = false, search = true, group = true, groupLabel = "Informations Complémentaires", groupName = "group2")
	...
	@Predicate(label = "Mots Clés", updatable = true, editable = false, search = false, group = true, groupLabel = "Informations Complémentaires", groupName = "group2")
	...
	private CourrierARelancer origanal;
	...
	public CourrierARelancer(String categorie, String niveauDeTraitement, TypeCourrier typecourrier, Priorite priorite,
	 ...
	 * 
	 */
	public CourrierARelancer() {
		// TODO Auto-generated constructor stub
	}

	public CourrierARelancer(CourrierARelancer dep) {
		...
		if (dep.origanal != null) {
			this.origanal = new CourrierARelancer(dep.origanal);
		}
		if (dep.bordero != null) {
	...
	public CourrierARelancer(CourrierDepart dep) {
	...
	public CourrierARelancer(Courrier dep) {
		super(dep.getId(), dep.getDesignation(), dep.getModuleName(), dep.getCompareid());
		this.categorie = dep.getCategorie();
		this.code = dep.getCode();
	...
	public CourrierARelancer(CourrierInterne dep) {
		super(dep.getId(), dep.getDesignation(), dep.getModuleName(), dep.getCompareid());
		this.categorie = dep.getCategorie();
		this.code = dep.getCode();
	...
	public CourrierARelancer getOriganal() {
		return origanal;
	}

	public void setOriganal(CourrierARelancer origanal) {
	...
	@Override
	public int compareTo(CourrierARelancer o) {
		// TODO Auto-generated method stub
		return code.compareTo(o.code);
	}

	public CourrierARelancer newInstace() {
		CourrierARelancer entity = new CourrierARelancer();
		...
		if (this.origanal != null) {
			entity.origanal = new CourrierARelancer(this.origanal);
		}
