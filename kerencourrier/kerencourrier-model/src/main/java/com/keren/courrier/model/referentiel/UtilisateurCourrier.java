...
@Entity
@Table(name = "T_CONTKC")
public class UtilisateurCourrier extends BaseElement implements Serializable, Comparable<UtilisateurCourrier> {
	...
	// values="Particulier;Personne Morale")
	private String nature = "3";

	@ManyToOne
	@JoinColumn(name = "T_CORRES")
	// @Predicate(label="Type de
	// Contact",updatable=true,type=TypeCorrespondant.class ,
	// target="many-to-one",search=true)
	// @Filter(value="[{\"fieldName\":\"nature\",\"value\":\"object.nature\",\"optional\":true,\"message\":\"Veuillez
	 ...
	 * 
	 */
	public UtilisateurCourrier() {
		// TODO Auto-generated constructor stub
	}

	public UtilisateurCourrier(TypeCorrespondant type, String structure, String sigle, Civilite civilite, String nom,
	...
	public UtilisateurCourrier(UtilisateurCourrier entity) {
	...
	@Override
	public int compareTo(UtilisateurCourrier o) {
		// TODO Auto-generated method stub
