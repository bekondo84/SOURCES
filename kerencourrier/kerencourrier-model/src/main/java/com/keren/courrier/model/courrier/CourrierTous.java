...
public class CourrierTous extends BaseElement implements Serializable, Comparable<CourrierTous> {
	...
	public CourrierTous(String categorie, String niveauDeTraitement, TypeCourrier typecourrier, Priorite priorite,
	...
	public CourrierTous(CourrierTous dep) {
...
//			this.origanal = new CourrierTous(dep.origanal);
//		}
//		if (dep.bordero != null) {
...
//		}
	...
	public CourrierTous(CourrierDepart dep) {
	...
	public CourrierTous(Courrier dep) {
		super(dep.getId(), dep.getDesignation(), dep.getModuleName(), dep.getCompareid());
		this.categorie = dep.getCategorie();
		this.code = dep.getCode();
	...
	public CourrierTous(CourrierInterne dep) {
		super(dep.getId(), dep.getDesignation(), dep.getModuleName(), dep.getCompareid());
		this.categorie = dep.getCategorie();
		this.code = dep.getCode();
	...
	public CourrierTous getOriganal() {
		return origanal;
	}

	public void setOriganal(CourrierTous origanal) {
	...
	@Override
	public int compareTo(CourrierTous o) {
		// TODO Auto-generated method stub
		return code.compareTo(o.code);
	}

	public CourrierTous newInstace() {
		CourrierTous entity = new CourrierTous();
		...
		if (this.origanal != null) {
			entity.origanal = new CourrierTous(this.origanal);
		}
