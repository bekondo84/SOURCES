 ...
 */
@Entity
@Table(name = "T_ACTBTGM")
public class ActiviteBT extends BaseElement implements Serializable,Comparable<ActiviteBT>{
    ...
    @Predicate(label = "Bon de travail",type = BonTravail.class,target = "many-to-one",optional = false,search = true)
...
//    @Predicate(label = "Projet",type = Projet.class,target = "many-to-one",optional = false,group = true,groupName = "group1",groupLabel = "Général")
     ...
     * @param comparedid 
     */
    public ActiviteBT(String code, Intervenant intervenant, BonTravail bontravail, Date dfin, Date ddebut, Diagnostic diagnostic, Remede remede, Equipement equipement, CentreFrais cfequipement, Organe organe, Rubrique rubrique, Double tppasse, Double tpindispo, UniteGestion unite, Double valeur, String commentaire, Projet projet, long id, String designation, String moduleName, long comparedid) {
     ...
     public ActiviteBT(ActiviteBT entity) {
        ...
        if(entity.cfequipement!=null){
            this.cfequipement = new CentreFrais(entity.cfequipement);
        }
    ...
    public String getListTitle() {
        return "Activités sur bon de travail"; //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    public String getEditTitle() {
        return "Activité sur bon de travail"; //To change body of generated methods, choose Tools | Templates.
    }
    
    
    @Override
    public int compareTo(ActiviteBT o) {
