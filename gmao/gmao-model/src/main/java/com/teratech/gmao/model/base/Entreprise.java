...
@XmlRootElement
public class Entreprise extends BaseElement implements Serializable,Comparable<Entreprise>{
    ...
    @Predicate(label = "Socièté mère" , type = Entreprise.class,target="many-to-one")
    @ManyToOne
    @JoinColumn(name = "SOCP_ID")
     private Entreprise societeMere ;
     ...
     * @param societeMere 
     */
    public Entreprise(String image, String code, String designation, String adresse, String telephone, String ville, String fax, String codePostal, String courriel, Pays pays, String numFiscal, String siteWeb, String registre, Devise devise, Entreprise societeMere) {
        this.image = image;
        this.code = code;
     ...
     * @param comparedid 
     */
    public Entreprise(String image, String code, String intitule, String adresse, String telephone, String ville, String fax, String codePostal, String courriel, Pays pays, String numFiscal, String siteWeb, String registre, Devise devise, Entreprise societeMere, long id, String designation, String moduleName, long comparedid) {
     ...
     public Entreprise(Entreprise entity) {
    ...
    public Entreprise getSocieteMere() {
        return societeMere;
    }

    public void setSocieteMere(Entreprise societeMere) {
        this.societeMere = societeMere;
    }
