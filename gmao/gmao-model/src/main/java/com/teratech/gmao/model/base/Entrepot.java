...
public class Entrepot extends BaseElement implements Serializable,Comparable<Entrepot>{
     ...
     * @param commentaire 
     */
    public Entrepot(String code, String intitule, String adresse1, String adresse2, String cp, String ville, Region region, Pays pays, String tel, String mobile, String email, String commentaire) {
        this.code = code;
     ...
     * @param moduleName 
     */
    public Entrepot(String code, String intitule, String adresse1, String adresse2, String cp, String ville, Region region, Pays pays, String tel, String mobile, String email, String commentaire, long id, String designation, String moduleName) {
