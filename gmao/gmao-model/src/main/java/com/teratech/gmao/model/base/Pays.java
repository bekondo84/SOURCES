...
public class Pays extends BaseElement implements Serializable,Comparable<Pays>{
    ...
    @Predicate(label = "Regions / Etats" , type = com.core.referentiels.Region.class,target = "one-to-many" ,group = true,groupName = "regions",groupLabel = "Régions", edittable = true)
