...
@Entity
@Table(name = "T_DEINGM")
public class DemandeIntervention extends BaseElement implements Serializable,Comparable<DemandeIntervention>{
    ...
    @Predicate(label = "",target = "richeditor",group = true,groupName = "group4",groupLabel = "Reponse",editable = false)
    @Lob
     ...
     * @param comparedid 
     */
    public DemandeIntervention(String code, Intervenant emetteur, Date dincident, String hincident, Intervenant destinataire, Rubrique rubrique, Equipement equipement, EtatEquipement etatEquipement, Organe organe, EtatEquipement etatOrgane, Priorite priorite, Symptome symptome, String localisation, String observation, BonTravail bontravail, Projet projet, Contrat contrat, UniteGestion unite, Double valcompter, String commentaire, String reponse, long id, String designation, String moduleName, long comparedid) {
    ...
    public DemandeIntervention(DemandeIntervention entity) {
    ...
    @Override
    public int compareTo(DemandeIntervention o) {
