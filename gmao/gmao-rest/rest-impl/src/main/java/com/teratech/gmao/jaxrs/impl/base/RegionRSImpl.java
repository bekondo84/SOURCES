...
import com.teratech.gmao.jaxrs.ifaces.base.RegionRS;
    ...
    implements RegionRS
{
     ...
     * 
     */
    @Manager(application = "teratechgmao", name = "RegionManagerImpl", interf = RegionManagerRemote.class)
    ...
    public MetaData getMetaData(HttpHeaders headers) {
        MetaData meta = null;
        try {
             meta = MetaDataUtil.getMetaData(new Region(), new HashMap<String, MetaData>(), new ArrayList<String>());
