...
import com.teratech.gmao.jaxrs.ifaces.budget.BudgetEquipementRS;
 ...
 * 
 */
@Path("/budgetequipement")
public class BudgetEquipementRSImpl
    extends AbstractGenericService<BudgetEquipement, Long>
    implements BudgetEquipementRS
{
     ...
     * 
     */
    @Manager(application = "teratechgmao", name = "BudgetEquipementManagerImpl", interf = BudgetEquipementManagerRemote.class)
    protected BudgetEquipementManagerRemote manager;

    public BudgetEquipementRSImpl() {
        super();
    }
     ...
     */
    @Override
    public GenericManager<BudgetEquipement, Long> getManager() {
        return manager;
    }
    ...
    public MetaData getMetaData(HttpHeaders headers) {
        ...
        try {
            ...
            meta = MetaDataUtil.getMetaData(new BudgetEquipement(), new HashMap<String, MetaData>(), new ArrayList<String>());
...
//        String annee = gson.fromJson(headers.getHeaderString("annee"), String.class);
    ...
    @Override
    protected void processBeforeUpdate(BudgetEquipement entity) {
    ...
    @Override
    protected void processBeforeSave(BudgetEquipement entity) {
        if(entity.getEquipement()==null){
            throw new KerenExecption("Le champ Division est obligatoire");
        }else if(entity.getAnnee()==null || entity.getAnnee().trim().isEmpty()){
            throw new KerenExecption("Le champ Exercice est obligatoire");
