...
import com.teratech.gmao.core.ifaces.base.DeviseManagerRemote;
import com.teratech.gmao.jaxrs.ifaces.base.DeviseRS;
    ...
    implements DeviseRS
{
     ...
     * 
     */
    @Manager(application = "teratechgmao", name = "DeviseManagerImpl", interf = DeviseManagerRemote.class)
