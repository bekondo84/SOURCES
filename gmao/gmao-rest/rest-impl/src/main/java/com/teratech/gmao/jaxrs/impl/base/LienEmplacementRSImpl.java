...
import com.teratech.gmao.jaxrs.ifaces.base.LienEmplacementRS;
    ...
    implements LienEmplacementRS
{
     ...
     * 
     */
    @Manager(application = "teratechgmao", name = "LienEmplacementManagerImpl", interf = LienEmplacementManagerRemote.class)
