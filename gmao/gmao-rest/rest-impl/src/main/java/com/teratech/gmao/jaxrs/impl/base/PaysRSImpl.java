...
import com.teratech.gmao.jaxrs.ifaces.base.PaysRS;
    ...
    implements PaysRS
{
     ...
     * 
     */
    @Manager(application = "teratechgmao", name = "PaysManagerImpl", interf = PaysManagerRemote.class)
    ...
    public MetaData getMetaData(HttpHeaders headers) {
        MetaData meta = null;
        try {
             meta = MetaDataUtil.getMetaData(new Pays(), new HashMap<String, MetaData>(), new ArrayList<String>());
