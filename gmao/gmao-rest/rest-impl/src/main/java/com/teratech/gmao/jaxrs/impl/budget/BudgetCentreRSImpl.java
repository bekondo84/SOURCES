...
import com.teratech.gmao.jaxrs.ifaces.budget.BudgetCentreRS;
 ...
 */
@Path("/budgetcentre")
public class BudgetCentreRSImpl
    extends AbstractGenericService<BudgetCentre, Long>
    implements BudgetCentreRS
{
     ...
     * 
     */
    @Manager(application = "teratechgmao", name = "BudgetCentreManagerImpl", interf = BudgetCentreManagerRemote.class)
    protected BudgetCentreManagerRemote manager;

    public BudgetCentreRSImpl() {
        super();
    }
     ...
     */
    @Override
    public GenericManager<BudgetCentre, Long> getManager() {
        return manager;
    }
    ...
    public MetaData getMetaData(HttpHeaders headers) {
        ...
        try {
            ...
            meta = MetaDataUtil.getMetaData(new BudgetCentre(), new HashMap<String, MetaData>(), new ArrayList<String>());
...
//        String annee = gson.fromJson(headers.getHeaderString("annee"), String.class);
    ...
    @Override
    protected void processBeforeUpdate(BudgetCentre entity) {
    ...
    @Override
    protected void processBeforeSave(BudgetCentre entity) {
        if(entity.getCentre()==null){
            throw new KerenExecption("Le champ Division est obligatoire");
        }else if(entity.getAnnee()==null || entity.getAnnee().trim().isEmpty()){
            throw new KerenExecption("Le champ Exercice est obligatoire");
