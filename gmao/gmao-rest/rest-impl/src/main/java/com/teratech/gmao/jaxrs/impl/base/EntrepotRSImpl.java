...
import com.teratech.gmao.jaxrs.ifaces.base.EntrepotRS;
    ...
    implements EntrepotRS
{
     ...
     * 
     */
    @Manager(application = "teratechgmao", name = "EntrepotManagerImpl", interf = EntrepotManagerRemote.class)
    ...
    public MetaData getMetaData(HttpHeaders headers) {
        MetaData meta = null;
        try {
             meta = MetaDataUtil.getMetaData(new Entrepot(), new HashMap<String, MetaData>(), new ArrayList<String>());
