...
public class Taxe extends BaseElement implements Serializable,Comparable<Taxe>{
    ...
    @Predicate(label = "porte.taxe",target = "combobox",values = "Ventes;Achats;Aucun",search = false)
    ...
    @Predicate(label = "societe",updatable = false,type = Structure.class,target = "many-to-one",search = true)
    ...
    public String getListTitle() {
        return "plan.txes"; //To change body of generated methods, choose Tools | Templates.
    }
