...
public class UniteAchat extends BaseElement implements Serializable,Comparable<UniteAchat>{
    ...
    @Predicate(label = "unite.gestion",type = UniteGestion.class,target = "many-to-one",search = true)
    ...
    public String getListTitle() {
        return "unites.achat"; //To change body of generated methods, choose Tools | Templates.
    }
