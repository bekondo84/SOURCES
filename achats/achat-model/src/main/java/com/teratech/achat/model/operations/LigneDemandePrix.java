 ...
 */
@Entity
@Table(name = "T_LIDP_ACH")
public class LigneDemandePrix extends BaseElement implements Serializable,Comparable<LigneDemandePrix>{
     ...
     * @param quantite 
     */
    public LigneDemandePrix(Article article, Double quantite) {
     ...
     * @param ligne 
     */
     public LigneDemandePrix(LigneDemandePrix ligne) {
     ...
     * @param moduleName 
     */
    public LigneDemandePrix(Article article, Double quantite, long id, String designation, String moduleName) {
    ...
    @Override
    public int compareTo(LigneDemandePrix o) {
