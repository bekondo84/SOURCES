...
public class Societe extends BaseElement implements Serializable,Comparable<Societe>{
    ...
    @Predicate(label = "logo.societe",search = false,target = "image")
     ...
     @Predicate(label = "nom.societe" ,optional = false,unique = true,search = true)
     private String code ;
     ...
     @Predicate(label = "siteweb",target = "url",group = true,groupName = "infosgenerales",groupLabel = "informations.generales")
