...
public class CategorieProduit extends BaseElement implements Serializable,Comparable<CategorieProduit>{
    ...
    @Predicate(label = "suivi.gestion.stock",type = Boolean.class)
    ...
    public String getListTitle() {
        return "categories.de.produits"; //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    public String getEditTitle() {
        return "categorie.de.produits"; //To change body of generated methods, choose Tools | Templates.
    }
