...
import com.teratech.achat.jaxrs.ifaces.base.DeviseRS;
    ...
    implements DeviseRS
{
     ...
     * 
     */
    @Manager(application = "teratechachat", name = "DeviseManagerImpl", interf = DeviseManagerRemote.class)
    ...
    public MetaData getMetaData(HttpHeaders headers) {
        try {
            return MetaDataUtil.getMetaData(new Devise(), new HashMap<String, MetaData>(), new ArrayList<String>()); //To change body of generated methods, choose Tools | Templates.
