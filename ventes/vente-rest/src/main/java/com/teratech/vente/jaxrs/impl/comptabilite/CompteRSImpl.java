...
import com.teratech.vente.core.ifaces.comptabilite.CompteManagerRemote;
import com.teratech.vente.jaxrs.ifaces.comptabilite.CompteRS;
    ...
    implements CompteRS
{
     ...
     * 
     */
    @Manager(application = "teratechvente", name = "CompteManagerImpl", interf = CompteManagerRemote.class)
