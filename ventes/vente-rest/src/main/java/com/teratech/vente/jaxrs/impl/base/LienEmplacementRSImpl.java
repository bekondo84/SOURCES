...
import com.teratech.vente.jaxrs.ifaces.base.LienEmplacementRS;
    ...
    implements LienEmplacementRS
{
     ...
     * 
     */
    @Manager(application = "teratechvente", name = "LienEmplacementManagerImpl", interf = LienEmplacementManagerRemote.class)
...
//        RestrictionsContainer container =  RestrictionsContainer.newInstance();
    ...
    public LienEmplacement delete(HttpHeaders headers, Long id) {
        try{
           ...
           throw  new KerenExecption("lien.emplacement.delete.error");
        }//To change body of generated methods, choose Tools | Templates.
    }
}
