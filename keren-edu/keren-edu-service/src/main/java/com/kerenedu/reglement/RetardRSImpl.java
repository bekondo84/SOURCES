    ...
    implements RetardRS
{
     ...
     * 
     */
    @Manager(application = "kereneducation", name = "RetardManagerImpl", interf = RetardManagerRemote.class)
    ...
    @Override
   	public MetaData getMetaData(HttpHeaders headers) {
   		...
   		try {
   			return MetaDataUtil.getMetaData(new Retard(), new HashMap<String, MetaData>(),new ArrayList<String>());
