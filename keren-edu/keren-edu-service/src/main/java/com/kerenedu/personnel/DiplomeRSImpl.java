    ...
    implements DiplomeRS
{
     ...
     * 
     */
    @Manager(application = "kereneducation", name = "DiplomeManagerImpl", interf = DiplomeManagerRemote.class)
    ...
    @Override
   	public MetaData getMetaData(HttpHeaders headers) {
   		...
   		try {
   			return MetaDataUtil.getMetaData(new Diplome(), new HashMap<String, MetaData>(),new ArrayList<String>());
   		}  catch (Exception e) {
