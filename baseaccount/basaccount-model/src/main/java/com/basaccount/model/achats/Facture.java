...
public class Facture extends DocumentAchat implements Serializable{
    ...
    public List<State> getStates() {
        ...
        State state = new State("transfere", "Transfert en comptabilité");
        states.add(state);
        state = new State("accepte", "Accepter");
        states.add(state);
        state = new State("valide", "Valider");
        states.add(state);
        state = new State("comptabilite", "Comptabiliser");
        states.add(state);
