 ...
 * @author BEKO
 */
public class JournalSaisieView extends BaseElement implements Serializable,Comparable<JournalSaisieView>{
    ...
    @Override
    public int compareTo(JournalSaisieView o) {
