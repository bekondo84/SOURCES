 ...
 * @author BEKO
 */
public class OperationBancaireView extends BaseElement implements Serializable,Comparable<OperationBancaireView>{
    ...
    @Override
    public int compareTo(OperationBancaireView o) {
