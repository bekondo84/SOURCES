...
public class LigneDocumentVente extends BaseElement implements Serializable,Comparable<LigneDocumentVente>{
...
//    private Date fabrication ;
    ...
    @Transient
    protected LigneDocumentVente ligneachat ;
     ...
     * @param totalht 
     */
    public LigneDocumentVente(Article article, Date prevue, Double quantite, Double puht, Double totalht) {
...
//        this.prevue = prevue;
     ...
     * @param moduleName 
     */
    public LigneDocumentVente(Article article, Date prevue, Double quantite, Double puht, Double totalht, long id, String designation, String moduleName) {
...
//        this.prevue = prevue;
     ...
     * @param ligne 
     */
    public LigneDocumentVente(LigneDocumentVente ligne) {
...
//    }
    ...
    public LigneDocumentVente getLigneachat() {
        return ligneachat;
    }

    public void setLigneachat(LigneDocumentVente ligneachat) {
    ...
    @Override
    public int compareTo(LigneDocumentVente o) {
