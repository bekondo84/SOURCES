...
public class NoteFraisVente extends BaseElement implements Serializable,Comparable<NoteFraisVente>{
...
//    @Predicate(label = "Date échéance",type = Date.class,optional = false,search = true)
    ...
    private List<LigneNoteFraisVente> notes = new ArrayList<LigneNoteFraisVente>();
     ...
     * @param journal 
     */
    public NoteFraisVente(String code, Tier fournisseur, Date date, Compte compte, Date decheance, String memo, JournalComptable journal) {
        this.code = code;
     ...
     * @param moduleName 
     */
    public NoteFraisVente(String code, Tier fournisseur, Date date, Compte compte, Date decheance, String memo, JournalComptable journal, long id, String designation, String moduleName) {
    ...
    public List<LigneNoteFraisVente> getNotes() {
        return notes;
    }

    public void setNotes(List<LigneNoteFraisVente> notes) {
        this.notes = notes;
    }
    ...
    @Override
    public int compareTo(NoteFraisVente o) {
