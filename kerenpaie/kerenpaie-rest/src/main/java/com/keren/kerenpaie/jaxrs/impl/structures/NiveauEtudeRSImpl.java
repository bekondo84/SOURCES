...
import com.keren.kerenpaie.jaxrs.ifaces.structures.NiveauEtudeRS;
    ...
    implements NiveauEtudeRS
{
     ...
     * 
     */
    @Manager(application = "kerenpaie", name = "NiveauEtudeManagerImpl", interf = NiveauEtudeManagerRemote.class)
