...
import com.keren.kerenpaie.jaxrs.ifaces.employes.DepartementSocRS;
    ...
    implements DepartementSocRS
{
     ...
     * 
     */
    @Manager(application = "kerenpaie", name = "DepartementSocManagerImpl", interf = DepartementSocManagerRemote.class)
