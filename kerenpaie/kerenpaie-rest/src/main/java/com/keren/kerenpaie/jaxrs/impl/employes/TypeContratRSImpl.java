...
import com.keren.kerenpaie.jaxrs.ifaces.employes.TypeContratRS;
    ...
    implements TypeContratRS
{
     ...
     * 
     */
    @Manager(application = "kerenpaie", name = "TypeContratManagerImpl", interf = TypeContratManagerRemote.class)
