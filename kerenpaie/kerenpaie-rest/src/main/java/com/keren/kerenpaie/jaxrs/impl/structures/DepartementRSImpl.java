...
import com.keren.kerenpaie.core.ifaces.structures.DepartementManagerRemote;
import com.keren.kerenpaie.jaxrs.ifaces.structures.DepartementRS;
    ...
    implements DepartementRS
{
     ...
     * 
     */
    @Manager(application = "kerenpaie", name = "DepartementManagerImpl", interf = DepartementManagerRemote.class)
    ...
    @Override
    public Departement delete(@Context HttpHeaders headers , Long id) {
