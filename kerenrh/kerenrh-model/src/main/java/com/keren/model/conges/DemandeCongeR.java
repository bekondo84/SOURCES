...
@Entity
@Table(name="T_DECORH")
public class DemandeCongeR extends BaseElement  implements Serializable,Comparable<DemandeCongeR>{
	 ...
	 * @param dc
	 */
	public DemandeCongeR(DemandeCongeR dc) {
	...
	public List<State> getStates() {
		// TODO Auto-generated method stub
			...
			states.add(etat);
			etat = new State("confirmer", "A approuvée");
			states.add(etat);
	...
	@Override
	public int compareTo(DemandeCongeR arg0) {
		// TODO Auto-generated method stub
