 ...
 * 
 */
public interface RepriseServiceRS
    extends GenericService<RepriseService, Long>
{
    ...
    @Path("confirme")
    public RepriseService confirmer(@Context HttpHeaders headers,RepriseService dmde);
