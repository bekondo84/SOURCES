...
public class ConditionPaiement extends BaseElement implements Serializable,Comparable<ConditionPaiement>{
    ...
    public String getListTitle() {
        return "conditions.paiements";  //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    public String getEditTitle() {
        return "condition.paiement"; //To change body of generated methods, choose Tools | Templates.
    }
