...
import com.teratech.stock.jaxrs.ifaces.base.EntrepotRS;
    ...
    implements EntrepotRS
{
     ...
     * 
     */
    @Manager(application = "teratechstock", name = "EntrepotManagerImpl", interf = EntrepotManagerRemote.class)
    ...
    public MetaData getMetaData(HttpHeaders headers) {
        try {
            ...
            return MetaDataUtil.getMetaData(new Entrepot(), new HashMap<String, MetaData>(), new ArrayList<String>());
