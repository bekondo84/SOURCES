    ...
    extends JPanel implements Observer
{
    ...
    private BalanceDialog _container ;
...
//    private static BalanceEditPanel 
    ...
    private void buildPanel(JPanel panel){
        ...
        lbmfileName = new JLabel();
         ...
         lbmoisGeneration.setText(MessagesBundle.getMessage("ebay.mois"));
...
//        private Observable mediator ;
    ...
    //            currentTreeNode.
            ...
            if(message.getStatut().equals(MessageType.IN_ERROR)){
               if(_container!=null){
//                    System.out.println(BalanceEditPanel.class.getSimpleName()+". :::::::::::::::::::::::::::::::::::::::  ");
     ...
     * @param _container 
     */
    public void setContainer(BalanceDialog _container) {
