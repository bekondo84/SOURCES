...
/**
 * Fenetre interne DeclarationFinanciereIFrame
 * @since Sun Apr 30 15:49:47 WAT 2017
 * 
 */
public class DeclarationFinanciereIFrame
    extends AbstractListTemplateFrame<DeclarationFinanciere, Long>
{
     ...
     * 
     */
    public DeclarationFinanciereIFrame() {
         super();
    }
    ...
    public Map getReportParameters() {
        ...
        parametres.put("titreRapport", MessagesBundle.getMessage("declarationfinanciere.title.report")) ;
        parametres.put("piedRapport", MessagesBundle.getMessage("declarationfinanciere.footer.report")) ;
    ...
    public String getJasperFileName() {
        if ((getSelectedObjects().size()==0 || getSelectedObjects().isEmpty())) {
            ...
            if ((getSelectedObjects().size()==1)) {
                return (ResourcesBundle.getResource("declarationfinanciere.detail.report"));
            } else {
                return (ResourcesBundle.getResource("declarationfinanciere.list.report"));
            }
        }
    }
    ...
    public String getWindowTitle() {
        return (MessagesBundle.getMessage("declarationfinanciere.list").toUpperCase());
    }
    ...
    public JPanel getCriteriaPanel() {
        if ((criteriaPanel==null)) {
            criteriaPanel = new DeclarationFinanciereCriteriaPanel();
        }
     ...
     */
    @Override
    public GenericManager<DeclarationFinanciere, Long> getManager()
        throws Exception
    {
        IocContext context = new IocContext();
        return (GenericManager)context.lookup("com.megatimgroup.core.impl.operations.DeclarationFinanciereManagerImpl");
    }
    ...
    public AbstractTableBaseListModel getTableModel() {
        if ((model==null)) {
             model = new DeclarationFinanciereModel();
        }
        return (model);
    }
     ...
     */
    @Override
    public JDialog getEditDialog(DeclarationFinanciere object, GenericManager manager, TypeOperation typeOperation, JFrame window)
        throws Exception
    {
        if ((object==null)) {
             object = new DeclarationFinanciere();
        }
        DeclarationFinanciereDialog  dialog = new DeclarationFinanciereDialog(getApplicationFrame() ,true, typeOperation) ;
