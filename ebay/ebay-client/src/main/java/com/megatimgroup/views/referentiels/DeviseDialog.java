...
/**
 * Boite de dialogue d'edition DeviseDialog
 * @since Sun Apr 30 15:49:47 WAT 2017
 * 
 */
public class DeviseDialog
    extends AbstractEditTemplateDialog<Devise, String>
{
     ...
     * @param parent
     */
    public DeviseDialog(Frame parent) {
         super(parent);
        interne = false ;
    }
     ...
     * @param parent
     */
    public DeviseDialog(Frame parent, String title) {
         super(parent , title);
        interne = false ;
    }
     ...
     * @param modal
     */
    public DeviseDialog(JFrame parent, Boolean modal, TypeOperation typeOperation) {
    ...
    public String getWindowTitle() {
        return (MessagesBundle.getMessage("devise.edit").toUpperCase());
    }
    ...
    public ImageIcon getImage() {
        try{
        ImageIcon icon = null;
        icon = new ImageIcon(getClass().getResource(ResourcesBundle.getResource("devise.edit.image")));
        return icon;
        }catch(Exception ex){;}
        return null;
    }
    ...
    public JPanel getFiledsPanel() {
        if ((middlePanel==null)) {
            middlePanel = new DeviseEditPanel() ;
        }
        return (middlePanel);
    }
