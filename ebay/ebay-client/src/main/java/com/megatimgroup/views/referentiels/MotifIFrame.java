...
/**
 * Fenetre interne MotifIFrame
 * @since Sun Apr 30 15:49:47 WAT 2017
 * 
 */
public class MotifIFrame
    extends AbstractListTemplateFrame<Motif, String>
{

    private MessagesBundle bundle;
    private ResourcesBundle resourcesbundle;
    public final static String FRAME_NAME = ("com.megatimgroup.views.referentiels.MotifIFrame");
     ...
     */
    @Override
    public String getPrimaryKey(Motif object) {
    ...
    public Map getReportParameters() {
        ...
        parametres.put("titreRapport", MessagesBundle.getMessage("motif.title.report")) ;
        parametres.put("piedRapport", MessagesBundle.getMessage("motif.footer.report")) ;
    ...
    public String getJasperFileName() {
        if ((getSelectedObjects().size()==0 || getSelectedObjects().isEmpty())) {
            ...
            if ((getSelectedObjects().size()==1)) {
                return (ResourcesBundle.getResource("motif.detail.report"));
            } else {
                return (ResourcesBundle.getResource("motif.list.report"));
            }
        }
    }
    ...
    public String getWindowTitle() {
        return (MessagesBundle.getMessage("motif.list"));
    }
    ...
    public ImageIcon getImage() {
        try{
        ImageIcon icon = null;
        icon = new ImageIcon(getClass().getResource(ResourcesBundle.getResource("motif.list.image")));
        return icon;
        } catch(Exception ex ){;}
        return null;
    }
    ...
    public JPanel getCriteriaPanel() {
        if ((criteriaPanel==null)) {
            criteriaPanel = new MotifCriteriaPanel();
        }
     ...
     */
    @Override
    public GenericManager<Motif, String> getManager()
        throws Exception
    {
    ...
    public String getWindowClassName() {
        return "com.megatimgroup.views.referentiels.MotifIFrame" ;
    }
     ...
     */
    @Override
    public JDialog getEditDialog(Motif object, GenericManager manager, TypeOperation typeOperation, JFrame window)
        throws Exception
    {
        if ((object==null)) {
             object = new Motif();
        }
        MotifDialog  dialog = new MotifDialog(getApplicationFrame() ,true, typeOperation) ;
