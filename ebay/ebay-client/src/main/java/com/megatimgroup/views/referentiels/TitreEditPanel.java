...
/**
 * Panel d'edition TitreEditPanel
 * @since Sun Apr 30 15:49:47 WAT 2017
 * 
 */
public class TitreEditPanel
    extends JPanel
{
    ...
    @Champ(mappedBy = "code", type = java.lang.String.class, nullable = false, update = false, errorMessageField = "lbmcode", errorMessage = "titre.code.error")
    private JTextField code;
    private JLabel lbcode;
    private JLabel lbmcode;
    @Champ(mappedBy = "designation", type = java.lang.String.class, errorMessageField = "lbmdesignation", errorMessage = "titre.designation.error")
    private JTextField designation;
    private JLabel lbdesignation;
    private JLabel lbmdesignation;

    public TitreEditPanel() {
        initComponents() ; 
    }
    ...
    private void initComponents() {
        ...
        lbcode = new JLabel();
        lbmcode = new JLabel();
         lbcode.setText(MessagesBundle.getMessage( "titre.code"));
        ...
        lbmdesignation = new JLabel();
         lbdesignation.setText(MessagesBundle.getMessage( "titre.designation"));
