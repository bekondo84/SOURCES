...
/**
 * Panel d'edition PaysEditPanel
 * @since Sun Apr 30 15:49:47 WAT 2017
 * 
 */
public class PaysEditPanel
    extends JPanel
{
    ...
    @Champ(mappedBy = "code", type = java.lang.String.class, nullable = false, update = false, errorMessageField = "lbmcode", errorMessage = "pays.code.error")
    private JTextField code;
    private JLabel lbcode;
    private JLabel lbmcode;
    @Champ(mappedBy = "designation", type = java.lang.String.class, errorMessageField = "lbmdesignation", errorMessage = "pays.designation.error")
    private JTextField designation;
    private JLabel lbdesignation;
    private JLabel lbmdesignation;

    public PaysEditPanel() {
        initComponents() ; 
    }
    ...
    private void initComponents() {
        ...
        lbcode = new JLabel();
        lbmcode = new JLabel();
         lbcode.setText(MessagesBundle.getMessage( "pays.code"));
        ...
        lbmdesignation = new JLabel();
         lbdesignation.setText(MessagesBundle.getMessage( "pays.designation"));
