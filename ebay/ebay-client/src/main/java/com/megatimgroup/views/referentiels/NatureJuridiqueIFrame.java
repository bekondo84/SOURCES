...
/**
 * Fenetre interne NatureJuridiqueIFrame
 * @since Sun Apr 30 15:49:47 WAT 2017
 * 
 */
public class NatureJuridiqueIFrame
    extends AbstractListTemplateFrame<NatureJuridique, String>
{
    ...
    public Map getReportParameters() {
        ...
        parametres.put("titreRapport", MessagesBundle.getMessage("naturejuridique.title.report")) ;
        parametres.put("piedRapport", MessagesBundle.getMessage("naturejuridique.footer.report")) ;
    ...
    public String getJasperFileName() {
        if ((getSelectedObjects().size()==0 || getSelectedObjects().isEmpty())) {
            ...
            if ((getSelectedObjects().size()==1)) {
                return (ResourcesBundle.getResource("naturejuridique.detail.report"));
            } else {
                return (ResourcesBundle.getResource("naturejuridique.list.report"));
            }
        }
    }
    ...
    public String getWindowTitle() {
        return (MessagesBundle.getMessage("naturejuridique.list"));
    }
    ...
    public ImageIcon getImage() {
        try{
        ImageIcon icon = null;
        icon = new ImageIcon(getClass().getResource(ResourcesBundle.getResource("naturejuridique.list.image")));
        return icon;
        } catch(Exception ex ){;}
        return null;
    }
    ...
    public JPanel getCriteriaPanel() {
        if ((criteriaPanel==null)) {
            criteriaPanel = new NatureJuridiqueCriteriaPanel();
        }
     ...
     */
    @Override
    public GenericManager<NatureJuridique, String> getManager()
        throws Exception
    {
    ...
    public AbstractTableBaseListModel getTableModel() {
        if ((model==null)) {
             model = new NatureJuridiqueModel();
        }
        return (model);
    }
     ...
     */
    @Override
    public JDialog getEditDialog(NatureJuridique object, GenericManager manager, TypeOperation typeOperation, JFrame window)
        throws Exception
    {
        if ((object==null)) {
             object = new NatureJuridique();
        }
        NatureJuridiqueDialog  dialog = new NatureJuridiqueDialog(getApplicationFrame() ,true, typeOperation) ;
