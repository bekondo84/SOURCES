    ...
    extends JPanel
{
    ...
    @Champ(mappedBy = "id", type = long.class, nullable = false, update = false, errorMessageField = "lbmid", errorMessage = "champ.id.error")
    private JFormattedTextField id;
    private JLabel lbid;
    private JLabel lbmid;
    @Champ(mappedBy = "fieldName", type = java.lang.String.class, errorMessageField = "lbmfieldname", errorMessage = "champ.fieldname.error")
    private JTextField fieldname;
    private JLabel lbfieldname;
    private JLabel lbmfieldname;

    public ChampEditPanel() {
        initComponents() ; 
    }
