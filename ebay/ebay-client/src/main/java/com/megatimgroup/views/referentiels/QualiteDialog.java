...
/**
 * Boite de dialogue d'edition QualiteDialog
 * @since Sun Apr 30 15:49:47 WAT 2017
 * 
 */
public class QualiteDialog
    extends AbstractEditTemplateDialog<Qualite, String>
{
     ...
     * @param parent
     */
    public QualiteDialog(Frame parent) {
         super(parent);
        interne = false ;
    }
     ...
     * @param parent
     */
    public QualiteDialog(Frame parent, String title) {
         super(parent , title);
        interne = false ;
    }
     ...
     * @param modal
     */
    public QualiteDialog(JFrame parent, Boolean modal, TypeOperation typeOperation) {
    ...
    public String getWindowTitle() {
        return (MessagesBundle.getMessage("qualite.edit"));
    }
    ...
    public ImageIcon getImage() {
        try{
        ImageIcon icon = null;
        icon = new ImageIcon(getClass().getResource(ResourcesBundle.getResource("qualite.edit.image")));
        return icon;
        }catch(Exception ex){;}
        return null;
    }
    ...
    public JPanel getFiledsPanel() {
        if ((middlePanel==null)) {
            middlePanel = new QualiteEditPanel() ;
        }
        return (middlePanel);
    }
