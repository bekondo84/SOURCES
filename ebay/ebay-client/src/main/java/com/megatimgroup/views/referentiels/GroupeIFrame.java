...
/**
 * Fenetre interne GroupeIFrame
 * @since Sun Apr 30 15:49:47 WAT 2017
 * 
 */
public class GroupeIFrame
    extends AbstractListTemplateFrame<Groupe, String>
{

    private MessagesBundle bundle;
    private ResourcesBundle resourcesbundle;
    public final static String FRAME_NAME = ("com.megatimgroup.views.referentiels.GroupeIFrame");
    ...
    public Map getReportParameters() {
        ...
        parametres.put("titreRapport", MessagesBundle.getMessage("groupe.title.report")) ;
        parametres.put("piedRapport", MessagesBundle.getMessage("groupe.footer.report")) ;
    ...
    public String getJasperFileName() {
        if ((getSelectedObjects().size()==0 || getSelectedObjects().isEmpty())) {
            ...
            if ((getSelectedObjects().size()==1)) {
                return (ResourcesBundle.getResource("groupe.detail.report"));
            } else {
                return (ResourcesBundle.getResource("groupe.list.report"));
            }
        }
    }
    ...
    public String getWindowTitle() {
        return (MessagesBundle.getMessage("groupe.list").toUpperCase());
    }
    ...
    public ImageIcon getImage() {
        try{
        ImageIcon icon = null;
        icon = new ImageIcon(getClass().getResource(ResourcesBundle.getResource("groupe.list.image")));
        return icon;
        } catch(Exception ex ){;}
        return null;
    }
    ...
    public JPanel getCriteriaPanel() {
        if ((criteriaPanel==null)) {
            criteriaPanel = new GroupeCriteriaPanel();
        }
     ...
     */
    @Override
    public GenericManager<Groupe, String> getManager()
        throws Exception
    {
     ...
     */
    @Override
    public JDialog getEditDialog(Groupe object, GenericManager manager, TypeOperation typeOperation, JFrame window)
        throws Exception
    {
        if ((object==null)) {
             object = new Groupe();
        }
        GroupeDialog  dialog = new GroupeDialog(getApplicationFrame() ,true, typeOperation) ;
