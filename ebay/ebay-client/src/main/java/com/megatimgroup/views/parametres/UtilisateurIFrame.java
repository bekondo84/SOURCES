...
public class UtilisateurIFrame
    extends AbstractListTemplateFrame<User, String>
{
     ...
     */
    @Override
    public String getPrimaryKey(User object) {
     ...
     */
    @Override
    public GenericManager<User, String> getManager()
        throws Exception
    {
        IocContext context = new IocContext();
        return (GenericManager)context.lookup("com.megatimgroup.core.impl.parametres.UserManagerImpl");
    }
     ...
     */
    @Override
    public JDialog getEditDialog(User object, GenericManager manager, TypeOperation typeOperation, JFrame window)
        throws Exception
    {
        if ((object==null)) {
             object = new User();
