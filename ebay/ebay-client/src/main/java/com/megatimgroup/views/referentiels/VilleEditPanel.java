...
/**
 * Panel d'edition VilleEditPanel
 * @since Sun Apr 30 15:49:47 WAT 2017
 * 
 */
public class VilleEditPanel
    extends JPanel
{
    ...
    @Champ(mappedBy = "code", type = java.lang.String.class, nullable = false, update = false, errorMessageField = "lbmcode", errorMessage = "ville.code.error")
    private JTextField code;
    private JLabel lbcode;
    private JLabel lbmcode;
    @Champ(mappedBy = "designation", type = java.lang.String.class, errorMessageField = "lbmdesignation", errorMessage = "ville.designation.error")
    private JTextField designation;
    private JLabel lbdesignation;
    private JLabel lbmdesignation;

    public VilleEditPanel() {
        initComponents() ; 
    }
