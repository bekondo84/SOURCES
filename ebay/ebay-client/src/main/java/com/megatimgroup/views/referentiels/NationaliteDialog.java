...
/**
 * Boite de dialogue d'edition NationaliteDialog
 * @since Sun Apr 30 15:49:47 WAT 2017
 * 
 */
public class NationaliteDialog
    extends AbstractEditTemplateDialog<Nationalite, String>
{
     ...
     * @param parent
     */
    public NationaliteDialog(Frame parent) {
         super(parent);
        interne = false ;
    }
     ...
     * @param parent
     */
    public NationaliteDialog(Frame parent, String title) {
         super(parent , title);
        interne = false ;
    }
     ...
     * @param modal
     */
    public NationaliteDialog(JFrame parent, Boolean modal, TypeOperation typeOperation) {
    ...
    public String getWindowTitle() {
        return (MessagesBundle.getMessage("nationalite.edit"));
    }
    ...
    public ImageIcon getImage() {
        try{
        ImageIcon icon = null;
        icon = new ImageIcon(getClass().getResource(ResourcesBundle.getResource("nationalite.edit.image")));
        return icon;
        }catch(Exception ex){;}
        return null;
    }
    ...
    public JPanel getFiledsPanel() {
        if ((middlePanel==null)) {
            middlePanel = new NationaliteEditPanel() ;
        }
        return (middlePanel);
    }
