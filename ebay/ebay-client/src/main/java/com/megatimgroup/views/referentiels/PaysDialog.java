...
/**
 * Boite de dialogue d'edition PaysDialog
 * @since Sun Apr 30 15:49:47 WAT 2017
 * 
 */
public class PaysDialog
    extends AbstractEditTemplateDialog<Pays, String>
{
     ...
     * @param parent
     */
    public PaysDialog(Frame parent) {
         super(parent);
        interne = false ;
    }
     ...
     * @param parent
     */
    public PaysDialog(Frame parent, String title) {
         super(parent , title);
        interne = false ;
    }
     ...
     * @param modal
     */
    public PaysDialog(JFrame parent, Boolean modal, TypeOperation typeOperation) {
    ...
    public String getWindowTitle() {
        return (MessagesBundle.getMessage("pays.edit"));
    }
    ...
    public ImageIcon getImage() {
        try{
        ImageIcon icon = null;
        icon = new ImageIcon(getClass().getResource(ResourcesBundle.getResource("pays.edit.image")));
        return icon;
        }catch(Exception ex){;}
        return null;
    }
