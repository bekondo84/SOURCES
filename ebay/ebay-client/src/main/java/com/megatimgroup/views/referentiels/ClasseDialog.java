...
/**
 * Boite de dialogue d'edition ClasseDialog
 * @since Sun Apr 30 15:49:47 WAT 2017
 * 
 */
public class ClasseDialog
    extends AbstractEditTemplateDialog<Classe, String>
{
     ...
     * @param parent
     */
    public ClasseDialog(Frame parent) {
         super(parent);
     ...
     * @param parent
     */
    public ClasseDialog(Frame parent, String title) {
         super(parent , title);
         this.setSize(200, 100);
        interne = false ;
    }
     ...
     * @param modal
     */
    public ClasseDialog(JFrame parent, Boolean modal, TypeOperation typeOperation) {
    ...
    public String getWindowTitle() {
        return (MessagesBundle.getMessage("classe.edit").toUpperCase());
    }
    ...
    public ImageIcon getImage() {
        try{
        ImageIcon icon = null;
        icon = new ImageIcon(getClass().getResource(ResourcesBundle.getResource("classe.edit.image")));
        return icon;
        }catch(Exception ex){;}
        return null;
    }
    ...
    public JPanel getFiledsPanel() {
        if ((middlePanel==null)) {
            middlePanel = new ClasseEditPanel() ;
        }
        return (middlePanel);
    }
