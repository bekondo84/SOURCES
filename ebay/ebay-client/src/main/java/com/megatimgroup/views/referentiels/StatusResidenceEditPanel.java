...
/**
 * Panel d'edition StatusResidenceEditPanel
 * @since Sun Apr 30 15:49:47 WAT 2017
 * 
 */
public class StatusResidenceEditPanel
    extends JPanel
{
    ...
    @Champ(mappedBy = "code", type = java.lang.String.class, nullable = false, update = false, errorMessageField = "lbmcode", errorMessage = "statusresidence.code.error")
    private JTextField code;
    private JLabel lbcode;
    private JLabel lbmcode;
    @Champ(mappedBy = "designation", type = java.lang.String.class, errorMessageField = "lbmdesignation", errorMessage = "statusresidence.designation.error")
    private JTextField designation;
    private JLabel lbdesignation;
    private JLabel lbmdesignation;

    public StatusResidenceEditPanel() {
        initComponents() ; 
    }
    ...
    private void initComponents() {
        ...
        lbcode = new JLabel();
        lbmcode = new JLabel();
         lbcode.setText(MessagesBundle.getMessage( "statusresidence.code"));
        ...
        lbmdesignation = new JLabel();
         lbdesignation.setText(MessagesBundle.getMessage( "statusresidence.designation"));
