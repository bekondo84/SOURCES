...
/**
 * Panel d'edition PrecisionDateNaissanceEditPanel
 * @since Sun Apr 30 15:49:47 WAT 2017
 * 
 */
public class PrecisionDateNaissanceEditPanel
    extends JPanel
{
    ...
    @Champ(mappedBy = "code", type = java.lang.String.class, nullable = false, update = false, errorMessageField = "lbmcode", errorMessage = "precisiondatenaissance.code.error")
    private JTextField code;
    private JLabel lbcode;
    private JLabel lbmcode;
    @Champ(mappedBy = "designation", type = java.lang.String.class, errorMessageField = "lbmdesignation", errorMessage = "precisiondatenaissance.designation.error")
    private JTextField designation;
    private JLabel lbdesignation;
    private JLabel lbmdesignation;

    public PrecisionDateNaissanceEditPanel() {
        initComponents() ; 
    }
    ...
    private void initComponents() {
        ...
        lbcode = new JLabel();
        lbmcode = new JLabel();
         lbcode.setText(MessagesBundle.getMessage( "precisiondatenaissance.code"));
        ...
        lbmdesignation = new JLabel();
         lbdesignation.setText(MessagesBundle.getMessage( "precisiondatenaissance.designation"));
