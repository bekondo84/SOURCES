...
/**
 * Fenetre interne TitreIFrame
 * @since Sun Apr 30 15:49:47 WAT 2017
 * 
 */
public class TitreIFrame
    extends AbstractListTemplateFrame<Titre, String>
{

    private MessagesBundle bundle;
    private ResourcesBundle resourcesbundle;
    public final static String FRAME_NAME = ("com.megatimgroup.views.referentiels.TitreIFrame");
     ...
     */
    @Override
    public String getPrimaryKey(Titre object) {
    ...
    public Map getReportParameters() {
        ...
        parametres.put("titreRapport", MessagesBundle.getMessage("titre.title.report")) ;
        parametres.put("piedRapport", MessagesBundle.getMessage("titre.footer.report")) ;
    ...
    public String getJasperFileName() {
        if ((getSelectedObjects().size()==0 || getSelectedObjects().isEmpty())) {
            ...
            if ((getSelectedObjects().size()==1)) {
                return (ResourcesBundle.getResource("titre.detail.report"));
            } else {
                return (ResourcesBundle.getResource("titre.list.report"));
            }
        }
    }
    ...
    public String getWindowTitle() {
        return (MessagesBundle.getMessage("titre.list"));
    }
    ...
    public ImageIcon getImage() {
        try{
        ImageIcon icon = null;
        icon = new ImageIcon(getClass().getResource(ResourcesBundle.getResource("titre.list.image")));
        return icon;
        } catch(Exception ex ){;}
        return null;
    }
    ...
    public JPanel getCriteriaPanel() {
        if ((criteriaPanel==null)) {
            criteriaPanel = new TitreCriteriaPanel();
        }
     ...
     */
    @Override
    public GenericManager<Titre, String> getManager()
        throws Exception
    {
    ...
    public String getWindowClassName() {
        return "com.megatimgroup.views.referentiels.TitreIFrame" ;
    }
     ...
     */
    @Override
    public JDialog getEditDialog(Titre object, GenericManager manager, TypeOperation typeOperation, JFrame window)
        throws Exception
    {
        if ((object==null)) {
             object = new Titre();
        }
        TitreDialog  dialog = new TitreDialog(getApplicationFrame() ,true, typeOperation) ;
