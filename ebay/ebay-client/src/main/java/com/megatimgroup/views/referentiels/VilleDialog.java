...
/**
 * Boite de dialogue d'edition VilleDialog
 * @since Sun Apr 30 15:49:47 WAT 2017
 * 
 */
public class VilleDialog
    extends AbstractEditTemplateDialog<Ville, String>
{
     ...
     * @param parent
     */
    public VilleDialog(Frame parent) {
         super(parent);
        interne = false ;
    }
     ...
     * @param parent
     */
    public VilleDialog(Frame parent, String title) {
         super(parent , title);
        interne = false ;
    }
     ...
     * @param modal
     */
    public VilleDialog(JFrame parent, Boolean modal, TypeOperation typeOperation) {
    ...
    public String getWindowTitle() {
        return (MessagesBundle.getMessage("ville.edit"));
    }
    ...
    public ImageIcon getImage() {
        try{
        ImageIcon icon = null;
        icon = new ImageIcon(getClass().getResource(ResourcesBundle.getResource("ville.edit.image")));
        return icon;
        }catch(Exception ex){;}
        return null;
    }
    ...
    public JPanel getFiledsPanel() {
        if ((middlePanel==null)) {
            middlePanel = new VilleEditPanel() ;
        }
        return (middlePanel);
    }
