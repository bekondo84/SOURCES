...
/**
 * Boite de dialogue d'edition SensOperationDialog
 * @since Sun Apr 30 15:49:47 WAT 2017
 * 
 */
public class SensOperationDialog
    extends AbstractEditTemplateDialog<SensOperation, String>
{
     ...
     * @param parent
     */
    public SensOperationDialog(Frame parent) {
         super(parent);
        interne = false ;
    }
     ...
     * @param parent
     */
    public SensOperationDialog(Frame parent, String title) {
         super(parent , title);
        interne = false ;
    }
     ...
     * @param modal
     */
    public SensOperationDialog(JFrame parent, Boolean modal, TypeOperation typeOperation) {
    ...
    public String getWindowTitle() {
        return (MessagesBundle.getMessage("sensoperation.edit"));
    }
    ...
    public ImageIcon getImage() {
        try{
        ImageIcon icon = null;
        icon = new ImageIcon(getClass().getResource(ResourcesBundle.getResource("sensoperation.edit.image")));
        return icon;
        }catch(Exception ex){;}
        return null;
    }
    ...
    public JPanel getFiledsPanel() {
        if ((middlePanel==null)) {
            middlePanel = new SensOperationEditPanel() ;
        }
        return (middlePanel);
    }
