...
/**
 * Boite de dialogue d'edition DivisionDialog
 * @since Sun Apr 30 15:49:47 WAT 2017
 * 
 */
public class DivisionDialog
    extends AbstractEditTemplateDialog<Division, String>
{
     ...
     * @param parent
     */
    public DivisionDialog(Frame parent) {
         super(parent);
        interne = false ;
    }
     ...
     * @param parent
     */
    public DivisionDialog(Frame parent, String title) {
         super(parent , title);
        interne = false ;
    }
     ...
     * @param modal
     */
    public DivisionDialog(JFrame parent, Boolean modal, TypeOperation typeOperation) {
     ...
     */
    @Override
    public String getPrimaryKey(Division object) {
    ...
    public String getWindowTitle() {
        return (MessagesBundle.getMessage("division.edit").toUpperCase());
    }
    ...
    public ImageIcon getImage() {
        try{
        ImageIcon icon = null;
        icon = new ImageIcon(getClass().getResource(ResourcesBundle.getResource("division.edit.image")));
        return icon;
        }catch(Exception ex){;}
        return null;
    }
    ...
    public JPanel getFiledsPanel() {
        if ((middlePanel==null)) {
            middlePanel = new DivisionEditPanel() ;
        }
        return (middlePanel);
    }
    ...
    public String getWindowClassName() {
         return "com.megatimgroup.views.referentiels.DivisionIFrame" ;
    }
    @Override
