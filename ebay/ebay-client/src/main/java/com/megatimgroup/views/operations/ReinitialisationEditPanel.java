 ...
 * 
 */
public class ReinitialisationEditPanel
    extends JPanel implements Observer
{
    ...
    private ReinitialisationDialog _container ;
    
    private JButton searchButton ;

    public ReinitialisationEditPanel() {
        initComponents() ; 
    }
...
//        System.out.println("******************* Reception des messages ::::::::::::::::::::::: "+o+"           "+arg+" ******** "+message.getErrors());
    ...
    public void setContainer(ReinitialisationDialog _container) {
