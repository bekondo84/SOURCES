...
/**
 * Boite de dialogue d'edition TypeOperationDialog
 * @since Sat Apr 29 15:47:15 WAT 2017
 * 
 */
public class TypeOperationDialog
    extends AbstractEditTemplateDialog<com.megatimgroup.model.referentiels.TypeOperation, String>
{
     ...
     * @param parent
     */
    public TypeOperationDialog(Frame parent) {
         super(parent);
        interne = false ;
    }
     ...
     * @param parent
     */
    public TypeOperationDialog(Frame parent, String title) {
         super(parent , title);
        interne = false ;
    }
     ...
     * @param modal
     */
    public TypeOperationDialog(JFrame parent, Boolean modal, com.megatim.common.utilities.TypeOperation typeOperation) {
    ...
    public String getWindowTitle() {
        return (MessagesBundle.getMessage("typeoperation.edit"));
    }
    ...
    public ImageIcon getImage() {
        try{
        ImageIcon icon = null;
        icon = new ImageIcon(getClass().getResource(ResourcesBundle.getResource("typeoperation.edit.image")));
        return icon;
        }catch(Exception ex){;}
        return null;
    }
    ...
    public JPanel getFiledsPanel() {
        if ((middlePanel==null)) {
            middlePanel = new TypeOperationEditPanel() ;
        }
        return (middlePanel);
    }
