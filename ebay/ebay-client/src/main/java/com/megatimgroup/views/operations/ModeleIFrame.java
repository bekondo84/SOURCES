...
/**
 * Fenetre interne ModeleIFrame
 * @since Sun Apr 30 13:05:42 WAT 2017
 * 
 */
public class ModeleIFrame
    extends AbstractListTemplateFrame<Modele, String>
{
    ...
    public Map getReportParameters() {
        ...
        parametres.put("titreRapport", MessagesBundle.getMessage("modele.title.report")) ;
        parametres.put("piedRapport", MessagesBundle.getMessage("modele.footer.report")) ;
    ...
    public String getJasperFileName() {
        if ((getSelectedObjects().size()==0 || getSelectedObjects().isEmpty())) {
            ...
            if ((getSelectedObjects().size()==1)) {
                return (ResourcesBundle.getResource("modele.detail.report"));
            } else {
                return (ResourcesBundle.getResource("modele.list.report"));
            }
        }
    }
    ...
    public String getWindowTitle() {
        return (MessagesBundle.getMessage("modele.list").toUpperCase());
    }
    ...
    public ImageIcon getImage() {
        try{
        ImageIcon icon = null;
        icon = new ImageIcon(getClass().getResource(ResourcesBundle.getResource("modele.list.image")));
        return icon;
        } catch(Exception ex ){;}
        return null;
    }
    ...
    public JPanel getCriteriaPanel() {
        if ((criteriaPanel==null)) {
            criteriaPanel = new ModeleCriteriaPanel();
        }
     ...
     */
    @Override
    public GenericManager<Modele, String> getManager()
        throws Exception
    {
     ...
     */
    @Override
    public JDialog getEditDialog(Modele object, GenericManager manager, TypeOperation typeOperation, JFrame window)
        throws Exception
    {
        if ((object==null)) {
             object = new Modele();
        }
        ModeleDialog  dialog = new ModeleDialog(getApplicationFrame() ,true, typeOperation) ;
