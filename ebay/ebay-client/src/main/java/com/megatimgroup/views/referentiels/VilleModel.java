...
/**
 * Modele de tableau VilleModel
 * @since Sun Apr 30 15:49:47 WAT 2017
 * 
 */
public class VilleModel
    extends AbstractTableBaseListModel<Ville>
{
    ...
    public String getColumnName(int columnIndex) {
        switch ((columnIndex)) {
            case  0 :
                return (MessagesBundle.getMessage("ville.code"));
            case  1 :
                return (MessagesBundle.getMessage("ville.designation"));
            default:
                return ("");
        }
    }
     ...
     */
    @Override
    public Object getColoumnValue(Ville data, int columnIndex) {
        switch ((columnIndex)) {
            case  0 :
                return (data.getCode());
            case  1 :
