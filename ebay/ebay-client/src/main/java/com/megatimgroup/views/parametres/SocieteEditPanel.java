...
/**
 * Panel d'edition SocieteEditPanel
 * @since Sun Apr 30 15:21:37 WAT 2017
 * 
 */
public class SocieteEditPanel
    extends JPanel
{
    ...
    @Champ(mappedBy = "code", type = java.lang.String.class, nullable = false,  errorMessageField = "lbmcode", errorMessage = "societe.code.error")
    private JTextField code;
    private JLabel lbcode;
    private JLabel lbmcode;
    @Champ(mappedBy = "designation", type = java.lang.String.class, errorMessageField = "lbmdesignation", errorMessage = "societe.designation.error")
    private JTextField designation;
    private JLabel lbdesignation;
    private JLabel lbmdesignation;
    @Champ(mappedBy = "raisonSocial", type = java.lang.String.class, errorMessageField = "lbmraisonsocial", errorMessage = "societe.raisonsocial.error")
    private JTextField raisonsocial;
    private JLabel lbraisonsocial;
    private JLabel lbmraisonsocial;

    public SocieteEditPanel() {
        initComponents() ; 
    }
