...
/**
 * Modele de tableau PaysModel
 * @since Sun Apr 30 15:49:47 WAT 2017
 * 
 */
public class PaysModel
    extends AbstractTableBaseListModel<Pays>
{
    ...
    public String getColumnName(int columnIndex) {
        switch ((columnIndex)) {
            case  0 :
                return (MessagesBundle.getMessage("pays.code"));
            case  1 :
                return (MessagesBundle.getMessage("pays.designation"));
            default:
                return ("");
        }
    }
     ...
     */
    @Override
    public Object getColoumnValue(Pays data, int columnIndex) {
        switch ((columnIndex)) {
            case  0 :
                return (data.getCode());
            case  1 :
