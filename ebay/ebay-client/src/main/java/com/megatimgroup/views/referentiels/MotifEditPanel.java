...
/**
 * Panel d'edition MotifEditPanel
 * @since Sun Apr 30 15:49:47 WAT 2017
 * 
 */
public class MotifEditPanel
    extends JPanel
{
    ...
    @Champ(mappedBy = "code", type = java.lang.String.class, nullable = false, update = false, errorMessageField = "lbmcode", errorMessage = "motif.code.error")
    private JTextField code;
    private JLabel lbcode;
    private JLabel lbmcode;
    @Champ(mappedBy = "designation", type = java.lang.String.class, errorMessageField = "lbmdesignation", errorMessage = "motif.designation.error")
    private JTextArea designation;
    private JLabel lbdesignation;
    private JLabel lbmdesignation;

    public MotifEditPanel() {
        initComponents() ; 
    }
     ...
     *     javax.swing.JTextField
     */
    public JTextArea getDesignation() {
        return designation;
    }
    ...
    private void initComponents() {
        ...
        code.addKeyListener(new KeyAdapter() {
            ...
            public void keyTyped(KeyEvent e) {
                ...
                if(!charS.matches("[0-9]")||code.getText().trim().length()>=6){
                    e.consume();
                }
            }
        ...
        designation = new JTextArea(10,10) ;
        ...
        col2h.addComponent(designation, javax.swing.GroupLayout.PREFERRED_SIZE , 300 , javax.swing.GroupLayout.PREFERRED_SIZE) ;
