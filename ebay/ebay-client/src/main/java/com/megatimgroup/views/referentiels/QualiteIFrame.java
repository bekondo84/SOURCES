...
/**
 * Fenetre interne QualiteIFrame
 * @since Sun Apr 30 15:49:47 WAT 2017
 * 
 */
public class QualiteIFrame
    extends AbstractListTemplateFrame<Qualite, String>
{

    private MessagesBundle bundle;
    private ResourcesBundle resourcesbundle;
    public final static String FRAME_NAME = ("com.megatimgroup.views.referentiels.QualiteIFrame");

    /**
     * Constructeur par defaut
     * 
     */
    public QualiteIFrame() {
         super();
    }
     ...
     */
    @Override
    public String getPrimaryKey(Qualite object) {
    ...
    public Map getReportParameters() {
        ...
        parametres.put("titreRapport", MessagesBundle.getMessage("qualite.title.report")) ;
        parametres.put("piedRapport", MessagesBundle.getMessage("qualite.footer.report")) ;
    ...
    public String getJasperFileName() {
        if ((getSelectedObjects().size()==0 || getSelectedObjects().isEmpty())) {
            ...
            if ((getSelectedObjects().size()==1)) {
                return (ResourcesBundle.getResource("qualite.detail.report"));
            } else {
                return (ResourcesBundle.getResource("qualite.list.report"));
            }
        }
    }
    ...
    public String getWindowTitle() {
        return (MessagesBundle.getMessage("qualite.list"));
    }
    ...
    public ImageIcon getImage() {
        try{
        ImageIcon icon = null;
        icon = new ImageIcon(getClass().getResource(ResourcesBundle.getResource("qualite.list.image")));
        return icon;
        } catch(Exception ex ){;}
        return null;
    }
    ...
    public JPanel getCriteriaPanel() {
        if ((criteriaPanel==null)) {
            criteriaPanel = new QualiteCriteriaPanel();
        }
     ...
     */
    @Override
    public GenericManager<Qualite, String> getManager()
        throws Exception
    {
    ...
    public String getWindowClassName() {
        return "com.megatimgroup.views.referentiels.QualiteIFrame" ;
    }
     ...
     */
    @Override
    public JDialog getEditDialog(Qualite object, GenericManager manager, TypeOperation typeOperation, JFrame window)
        throws Exception
    {
        if ((object==null)) {
             object = new Qualite();
        }
        QualiteDialog  dialog = new QualiteDialog(getApplicationFrame() ,true, typeOperation) ;
