...
/**
 * Modele de tableau SectionModel
 * @since Sun Apr 30 15:49:47 WAT 2017
 * 
 */
public class SectionModel
    extends AbstractTableBaseListModel<Section>
{
    ...
    public String getColumnName(int columnIndex) {
        switch ((columnIndex)) {
            case  0 :
                return (MessagesBundle.getMessage("section.code"));
            case  1 :
                return (MessagesBundle.getMessage("section.designation"));
            default:
                return ("");
        }
    }
     ...
     */
    @Override
    public Object getColoumnValue(Section data, int columnIndex) {
        switch ((columnIndex)) {
            case  0 :
                return (data.getCode());
            case  1 :
