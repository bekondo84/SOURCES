...
/**
 * Boite de dialogue d'edition TitreDialog
 * @since Sun Apr 30 15:49:47 WAT 2017
 * 
 */
public class TitreDialog
    extends AbstractEditTemplateDialog<Titre, String>
{
     ...
     * @param parent
     */
    public TitreDialog(Frame parent) {
         super(parent);
        interne = false ;
    }
     ...
     * @param parent
     */
    public TitreDialog(Frame parent, String title) {
         super(parent , title);
        interne = false ;
    }
     ...
     * @param modal
     */
    public TitreDialog(JFrame parent, Boolean modal, TypeOperation typeOperation) {
    ...
    public String getWindowTitle() {
        return (MessagesBundle.getMessage("titre.edit"));
    }
    ...
    public ImageIcon getImage() {
        try{
        ImageIcon icon = null;
        icon = new ImageIcon(getClass().getResource(ResourcesBundle.getResource("titre.edit.image")));
        return icon;
        }catch(Exception ex){;}
        return null;
    }
    ...
    public JPanel getFiledsPanel() {
        if ((middlePanel==null)) {
            middlePanel = new TitreEditPanel() ;
        }
        return (middlePanel);
    }
