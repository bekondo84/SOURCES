...
/**
 * Modele de tableau NatureJuridiqueModel
 * @since Sun Apr 30 15:49:47 WAT 2017
 * 
 */
public class NatureJuridiqueModel
    extends AbstractTableBaseListModel<NatureJuridique>
{

    protected MessagesBundle bundle;

    public NatureJuridiqueModel() {
        super() ; 
    }
    ...
    public String getColumnName(int columnIndex) {
        switch ((columnIndex)) {
            case  0 :
                return (MessagesBundle.getMessage("naturejuridique.code"));
            case  1 :
                return (MessagesBundle.getMessage("naturejuridique.designation"));
            default:
                return ("");
        }
    }
     ...
     */
    @Override
    public Object getColoumnValue(NatureJuridique data, int columnIndex) {
        switch ((columnIndex)) {
            case  0 :
                return (data.getCode());
            case  1 :
