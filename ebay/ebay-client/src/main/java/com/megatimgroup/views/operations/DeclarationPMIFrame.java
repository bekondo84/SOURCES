...
/**
 * Fenetre interne DeclarationPMIFrame

 * @since Sun Apr 30 15:49:47 WAT 2017
 * 
 */
public class DeclarationPMIFrame
    extends AbstractListTemplateFrame<DeclarationPM, String>
{
    ...
    public Map getReportParameters() {
        ...
        parametres.put("titreRapport", MessagesBundle.getMessage("declarationpm.title.report")) ;
        parametres.put("piedRapport", MessagesBundle.getMessage("declarationpm.footer.report")) ;
    ...
    public String getJasperFileName() {
        if ((getSelectedObjects().size()==0 || getSelectedObjects().isEmpty())) {
            ...
            if ((getSelectedObjects().size()==1)) {
                return (ResourcesBundle.getResource("declarationpm.detail.report"));
            } else {
                return (ResourcesBundle.getResource("declarationpm.list.report"));
            }
        }
    }
    ...
    public String getWindowTitle() {
        return (MessagesBundle.getMessage("declarationpm.list").toUpperCase());
    }
    ...
    public ImageIcon getImage() {
        try{
        ImageIcon icon = null;
        icon = new ImageIcon(getClass().getResource(ResourcesBundle.getResource("declarationpm.list.image")));
        return icon;
        } catch(Exception ex ){;}
        return null;
    }
    ...
    public JPanel getCriteriaPanel() {
        if ((criteriaPanel==null)) {
            criteriaPanel = new DeclarationPMCriteriaPanel();
        }
     ...
     */
    @Override
    public GenericManager<DeclarationPM, Long> getManager()
        throws Exception
    {
        IocContext context = new IocContext();
        return (GenericManager)context.lookup("com.megatimgroup.core.impl.operations.DeclarationPMManagerImpl");
    }
     ...
     */
    @Override
    public JDialog getEditDialog(DeclarationPM object, GenericManager manager, TypeOperation typeOperation, JFrame window)
        throws Exception
    {
        if ((object==null)) {
             object = new DeclarationPM();
        }
        DeclarationPMDialog  dialog = new DeclarationPMDialog(getApplicationFrame() ,true, typeOperation) ;
