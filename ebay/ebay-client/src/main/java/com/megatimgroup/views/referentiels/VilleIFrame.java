...
/**
 * Fenetre interne VilleIFrame
 * @since Sun Apr 30 15:49:47 WAT 2017
 * 
 */
public class VilleIFrame
    extends AbstractListTemplateFrame<Ville, String>
{
     ...
     */
    @Override
    public String getPrimaryKey(Ville object) {
    ...
    public Map getReportParameters() {
        ...
        parametres.put("titreRapport", MessagesBundle.getMessage("ville.title.report")) ;
        parametres.put("piedRapport", MessagesBundle.getMessage("ville.footer.report")) ;
    ...
    public String getJasperFileName() {
        if ((getSelectedObjects().size()==0 || getSelectedObjects().isEmpty())) {
            ...
            if ((getSelectedObjects().size()==1)) {
                return (ResourcesBundle.getResource("ville.detail.report"));
            } else {
                return (ResourcesBundle.getResource("ville.list.report"));
            }
        }
    }
    ...
    public String getWindowTitle() {
        return (MessagesBundle.getMessage("ville.list"));
    }
    ...
    public ImageIcon getImage() {
        try{
        ImageIcon icon = null;
        icon = new ImageIcon(getClass().getResource(ResourcesBundle.getResource("ville.list.image")));
        return icon;
        } catch(Exception ex ){;}
        return null;
    }
    ...
    public JPanel getCriteriaPanel() {
        if ((criteriaPanel==null)) {
            criteriaPanel = new VilleCriteriaPanel();
        }
     ...
     */
    @Override
    public GenericManager<Ville, String> getManager()
        throws Exception
    {
    ...
    public String getWindowClassName() {
        return "com.megatimgroup.views.referentiels.VilleIFrame" ;
    }
     ...
     */
    @Override
    public JDialog getEditDialog(Ville object, GenericManager manager, TypeOperation typeOperation, JFrame window)
        throws Exception
    {
        if ((object==null)) {
             object = new Ville();
        }
        VilleDialog  dialog = new VilleDialog(getApplicationFrame() ,true, typeOperation) ;
