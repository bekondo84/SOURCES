...
/**
 * Boite de dialogue d'edition NatureJuridiqueDialog
 * @since Sun Apr 30 15:49:47 WAT 2017
 * 
 */
public class NatureJuridiqueDialog
    extends AbstractEditTemplateDialog<NatureJuridique, String>
{
     ...
     * @param parent
     */
    public NatureJuridiqueDialog(Frame parent) {
         super(parent);
        interne = false ;
    }
     ...
     * @param parent
     */
    public NatureJuridiqueDialog(Frame parent, String title) {
         super(parent , title);
        interne = false ;
    }
     ...
     * @param modal
     */
    public NatureJuridiqueDialog(JFrame parent, Boolean modal, TypeOperation typeOperation) {
     ...
     */
    @Override
    public String getPrimaryKey(NatureJuridique object) {
    ...
    public String getWindowTitle() {
        return (MessagesBundle.getMessage("naturejuridique.edit"));
    }
    ...
    public ImageIcon getImage() {
        try{
        ImageIcon icon = null;
        icon = new ImageIcon(getClass().getResource(ResourcesBundle.getResource("naturejuridique.edit.image")));
        return icon;
        }catch(Exception ex){;}
        return null;
    }
    ...
    public JPanel getFiledsPanel() {
        if ((middlePanel==null)) {
            middlePanel = new NatureJuridiqueEditPanel() ;
        }
        return (middlePanel);
    }
    ...
    public String getWindowClassName() {
         return "com.megatimgroup.views.referentiels.NatureJuridiqueIFrame" ;
    }
    @Override
