...
/**
 * Modele de tableau SensOperationModel
 * @since Sun Apr 30 15:49:47 WAT 2017
 * 
 */
public class SensOperationModel
    extends AbstractTableBaseListModel<SensOperation>
{

    protected MessagesBundle bundle;

    public SensOperationModel() {
        super() ; 
    }
    ...
    public String getColumnName(int columnIndex) {
        switch ((columnIndex)) {
            case  0 :
                return (MessagesBundle.getMessage("sensoperation.code"));
            case  1 :
                return (MessagesBundle.getMessage("sensoperation.designation"));
            default:
                return ("");
        }
    }
     ...
     */
    @Override
    public Object getColoumnValue(SensOperation data, int columnIndex) {
        switch ((columnIndex)) {
            case  0 :
                return (data.getCode());
            case  1 :
