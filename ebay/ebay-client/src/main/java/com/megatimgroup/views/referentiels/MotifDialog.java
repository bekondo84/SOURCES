...
/**
 * Boite de dialogue d'edition MotifDialog
 * @since Sun Apr 30 15:49:47 WAT 2017
 * 
 */
public class MotifDialog
    extends AbstractEditTemplateDialog<Motif, String>
{
     ...
     * @param parent
     */
    public MotifDialog(Frame parent) {
         super(parent);
        interne = false ;
    }
     ...
     * @param parent
     */
    public MotifDialog(Frame parent, String title) {
         super(parent , title);
        interne = false ;
    }
     ...
     * @param modal
     */
    public MotifDialog(JFrame parent, Boolean modal, TypeOperation typeOperation) {
    ...
    public String getWindowTitle() {
        return (MessagesBundle.getMessage("motif.edit").toUpperCase());
    }
    ...
    public ImageIcon getImage() {
        try{
        ImageIcon icon = null;
        icon = new ImageIcon(getClass().getResource(ResourcesBundle.getResource("motif.edit.image")));
        return icon;
        }catch(Exception ex){;}
        return null;
    }
    ...
    public JPanel getFiledsPanel() {
        if ((middlePanel==null)) {
            middlePanel = new MotifEditPanel() ;
        }
        return (middlePanel);
    }
