...
/**
 * Boite de dialogue d'edition PrecisionDateNaissanceDialog
 * @since Sun Apr 30 15:49:47 WAT 2017
 * 
 */
public class PrecisionDateNaissanceDialog
    extends AbstractEditTemplateDialog<PrecisionDateNaissance, String>
{
     ...
     * 
     */
    public PrecisionDateNaissanceDialog() {
    }
     ...
     * @param parent
     */
    public PrecisionDateNaissanceDialog(Frame parent) {
         super(parent);
        interne = false ;
    }
     ...
     * @param parent
     */
    public PrecisionDateNaissanceDialog(Frame parent, String title) {
         super(parent , title);
        interne = false ;
    }
     ...
     * @param modal
     */
    public PrecisionDateNaissanceDialog(JFrame parent, Boolean modal, TypeOperation typeOperation) {
    ...
    public String getWindowTitle() {
        return (MessagesBundle.getMessage("precisiondatenaissance.edit"));
    }
    ...
    public ImageIcon getImage() {
        try{
        ImageIcon icon = null;
        icon = new ImageIcon(getClass().getResource(ResourcesBundle.getResource("precisiondatenaissance.edit.image")));
        return icon;
        }catch(Exception ex){;}
        return null;
    }
    ...
    public JPanel getFiledsPanel() {
        if ((middlePanel==null)) {
            middlePanel = new PrecisionDateNaissanceEditPanel() ;
        }
        return (middlePanel);
    }
