...
import com.megatimgroup.dao.ifaces.referentiels.SensOperationDAO;
 ...
 * 
 */
public class SensOperationDAOImpl
    extends AbstractGenericDAO<SensOperation, String>
    implements SensOperationDAO
{
     ...
     */
    @Override
    public Class<SensOperation> getManagedEntityClass() {
        return (SensOperation.class);
    }
