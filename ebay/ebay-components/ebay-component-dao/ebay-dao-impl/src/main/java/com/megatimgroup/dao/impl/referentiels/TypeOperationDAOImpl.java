...
import com.megatimgroup.dao.ifaces.referentiels.TypeOperationDAO;
 ...
 * 
 */
public class TypeOperationDAOImpl
    extends AbstractGenericDAO<TypeOperation, String>
    implements TypeOperationDAO
{
     ...
     */
    @Override
    public Class<TypeOperation> getManagedEntityClass() {
