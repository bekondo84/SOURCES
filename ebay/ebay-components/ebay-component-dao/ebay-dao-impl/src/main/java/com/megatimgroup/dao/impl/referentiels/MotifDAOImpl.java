...
import com.megatimgroup.dao.ifaces.referentiels.MotifDAO;
 ...
 * 
 */
public class MotifDAOImpl
    extends AbstractGenericDAO<Motif, String>
    implements MotifDAO
{
     ...
     */
    @Override
    public Class<Motif> getManagedEntityClass() {
        return (Motif.class);
    }
