...
import com.megatimgroup.dao.ifaces.operations.ModeleDAO;
 ...
 * 
 */
public class ModeleDAOImpl
    extends AbstractGenericDAO<Modele, String>
    implements ModeleDAO
{
     ...
     */
    @Override
    public Class<Modele> getManagedEntityClass() {
        return (Modele.class);
    }
