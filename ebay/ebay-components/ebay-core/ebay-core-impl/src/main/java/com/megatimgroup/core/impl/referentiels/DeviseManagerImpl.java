...
public class DeviseManagerImpl
    extends AbstractGenericManager<Devise, String>
    implements DeviseManager
{
     ...
     * 
     */
    @Inject("com.megatimgroup.dao.impl.referentiels.DeviseDAOImpl")
     ...
     */
    @Override
    public GenericDAO<Devise, String> getDao() {
        return dao;
    }
