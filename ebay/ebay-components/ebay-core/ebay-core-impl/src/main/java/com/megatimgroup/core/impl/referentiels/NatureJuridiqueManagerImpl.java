 ...
 */
@Transaction
public class NatureJuridiqueManagerImpl
    extends AbstractGenericManager<NatureJuridique, String>
    implements NatureJuridiqueManager
{
     ...
     * 
     */
    @Inject("com.megatimgroup.dao.impl.referentiels.NatureJuridiqueDAOImpl")
    protected GenericDAO dao;

    public NatureJuridiqueManagerImpl() {
    }
     ...
     */
    @Override
    public GenericDAO<NatureJuridique, String> getDao() {
        return dao;
    }
